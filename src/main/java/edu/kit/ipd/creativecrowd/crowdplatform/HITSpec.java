...
public class HITSpec {
	...
	/**
	 * We really do not need the xml link for pybossa, the raw does just fine.
	 * @author Robin
	 */
	...
	public HITSpec( String title, String description,
		...
		this.setExternalURL(externalQuestionURL);
...
//		}
	...
	public void setQualifications(Iterable<String> qualifications)
		...
		{
		for (@SuppressWarnings("unused") String qualification : qualifications) {
			amount++;
		}
	...
	/**
	 * This method returns the raw URL
	 * @author Robin
	 * @return the raw URL
	 */
	...
	/**
	 * This method sets the external URL, i might make it private later
	 * @author Robin
	 * @param externalURL the raw url
	 */
