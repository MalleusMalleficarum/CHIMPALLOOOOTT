 ...
 */
public class MTurkConnection extends AbstractConnection {
	 ...
	 */
	public void approveHIT(AssignmentId AssignmentId, WorkerId workerId, String feedback)
	...
	public PlatformIdentity getPlatformIdentity() {
	    return PlatformIdentity.MTurk;
	}
	public String getAbbrevation() {
		return PlatformIdentity.MTurk.getPrefix();
	}
}
