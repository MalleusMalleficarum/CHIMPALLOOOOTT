...
public class MTurkConnectionTest {
	...
	{
		turkConnection.approveHIT(new AssignmentId("new_assignment_id"), new WorkerId("I bin oa wörka Ai-Dieh"),"my feedback message");
	}
	...
	public void testGetPlatformIdentity() {
		assertEquals(PlatformIdentity.MTurk, turkConnection.getPlatformIdentity());
	}
	@Test
	public void testGetAbbrevation() {
		assertEquals("MT", turkConnection.getAbbrevation());
	}
